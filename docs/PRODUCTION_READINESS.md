...
**Still open:** the remaining manual pass (authz spot-checks across blueprints, rate-limit coverage beyond login) and a runtime tenant-isolation review once that feature is activated.
